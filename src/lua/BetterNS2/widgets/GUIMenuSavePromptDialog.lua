...
---@class GUIMenuSavePromptDialog : GUIMenuPopupDialog
class "GUIMenuSavePromptDialog" (GUIMenuPopupDialog)
...
GUIMenuSavePromptDialog:AddCompositeClassProperty("Message", "message", "Text")
...
function GUIMenuSavePromptDialog:Initialize(params, errorDepth)
    ...
    self.filename = CreateGUIObject("filename", GUIMenuTextEntryWidget, self.layout,
            {
                label = "Filename",
            })
...
function GUIMenuSavePromptDialog:GetSaveFilename()
